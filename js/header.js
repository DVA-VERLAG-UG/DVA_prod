...
(() => {
  const ROUTES = {
    de: { home:"/de/", about:"/de/ueber-uns/", contact:"/de/kontakt/", projects:"/de/projekte/", services:"/de/pakete/",konfig:"/de/konfig/", process:"/de/prozess/", blog:"/de/blog/" },
  ...
  /* =========================================================
     ✅ Social Bar config (same UI everywhere, generated by header)
     ========================================================= */
const SOCIAL = {
    ...
    email:    { href: "mailto:contact@example.com",  label: "Email",    icon: "/assets/icons/email.png" },
  };
...
/* ✅ MOBILE FIX: Keep header at 60px height, tighter spacing */
...
@media (max-width: 360px){
  #site-header .site-search{ height: 34px; }
  #site-header .brand img{ width: 26px; height: 26px; }
  #site-header .theme-btn{ width: 34px; height: 34px; }
  #site-header .burger{ width: 34px; height: 34px; }
}
...
/* Dark mode styles for social bar */
...
html[data-theme="dim"] #dvFloatSocial .dv-follow-text{
...
/* Dark mode icons - invert colors for white icons */
html[data-theme="dim"] #dvFloatSocial img{
  filter: brightness(0) invert(1);
}

/* desktop toggle - hidden in this design */
#dvFloatSocial .dv-float-toggle{
  display: none;
}

/* collapse state - not used in this design */
...
function socialHTML() {
    ...
    return `
      <div class="dv-float-social" id="dvFloatSocial" aria-label="Social Bar">
        <div class="dv-follow-text">FOLLOW US</div>
        ...
        <a href="${SOCIAL.email.href}" aria-label="${SOCIAL.email.label}">
          <img src="${SOCIAL.email.icon}" alt="${SOCIAL.email.label}">
        </a>
    ...
    return `
      ...
      <aside class="drawer" data-drawer aria-label="Menu">
        ...
        <nav>
          ...
          <a href="${ROUTES[lang].konfig}">${L.konfig}</a>
