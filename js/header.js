...
/* =========================================================
   ✅ FLOATING SOCIAL BAR (generated by header.js)
   ========================================================= */
...
#dvFloatSocial .dv-float-toggle:hover{
...
/* Collapse state (desktop): hide icons smoothly, keep toggle */
...
/* ✅ Mobile bottom pill variant (forced visible) */
@media (max-width: 768px), (hover: none) {
  #dvFloatSocial.dv-float-social{
    ...
    /* IMPORTANT: allow hide/show to work */
...
`;
  ...
  function ensureSocialBarExists() {
    ...
    // create once globally (outside header mount so it floats everywhere)
  ...
  function initSocialBarLogic() {
    ...
    function hideBar(){ bar.classList.add("is-scroll-hidden"); }
